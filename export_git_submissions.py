...
from marking import canvas_api, mongodb_store, marking_actions, marks, file_actions, git_actions, java_actions, print_courses, print_assignments
import requests
...
if __name__ == "__main__":
    ...
    assignments = capi.get_assignments(rp)
